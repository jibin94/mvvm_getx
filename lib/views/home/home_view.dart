...
import 'package:mvvm_getx/res/components/internet_exception_widgets.dart';
...
import 'package:mvvm_getx/view_models/controller/user_preferences/user_preference_view_model.dart';
import 'package:mvvm_getx/views/home/widgets/userlist_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Text('dashboard'.tr, style: const TextStyle(color: Colors.white)),
        centerTitle: true,
